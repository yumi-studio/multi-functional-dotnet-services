...
using YumiStudio.API.Middlewares;
...
using ApplicationInterfacesFakebook = YumiStudio.Application.Interfaces.Fakebook;
using YumiStudio.Application.Services;
using ApplicationServicesFakebook = YumiStudio.Application.Services.Fakebook;
using YumiStudio.Domain.Interfaces;
using DomainInterfacesFakebook = YumiStudio.Domain.Interfaces.Fakebook;
using YumiStudio.Infrastructure.Repositories;
using InfrastructureRepositoriesFakebook = YumiStudio.Infrastructure.Repositories.Fakebook;
